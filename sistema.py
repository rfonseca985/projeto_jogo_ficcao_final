'''
Criadores: Elisama Talita, Nivia Campos, Rafael Fonseca

'''

from classes_metodos import inicio, Formatacao, ContaTempo, menu_inicial, menu


if __name__ == "__main__":
    formato = Formatacao()
    formato.cabecalho('VOLTE AO SEU CORPO!!!')
        ...
        if resposta == 1:
            ...
            if respostaC == 0:
                ...
                if tempo_jogo.tempo_final():
                    ...
                    break
                respostaC1 = menu(
                    ['Anotações página 1.', 'Anotações página 30.', 'Anotações página 315.'])
                if respostaC1 == 0:
                    formato.animacao('\033[31mAté a próxima!\033[m\n')
                    break
                elif respostaC1 == 1:
